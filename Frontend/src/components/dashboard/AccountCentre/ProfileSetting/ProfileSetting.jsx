...
const ProfileSetting = () => {
  ...
  const fetchProfile = async () => {
    try {
      const res = await axios.get(
        "http://32.192.230.40:5050/api/profile-settings",
        {
          headers: {
  ...
  const sendOldPhoneOtp = async () => {
    try {
      await axios.post(
        "http://32.192.230.40:5050/api/auth/send-otp",
        { phone }, // OLD phone
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem("token")}`,
  ...
  const verifyOldPhoneOtp = async () => {
    ...
    try {
      await axios.post(
        "http://32.192.230.40:5050/api/profile-settings/verify-old-phone",
        { otp: otpValue },
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem("token")}`,
  ...
  const verifyOldEmailOtp = async () => {
    ...
    try {
      await axios.post(
        "http://32.192.230.40:5050/api/profile-settings/verify-old-email",
        { otp: otpValue },
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem("token")}`,
  ...
  const sendOtp = async (type) => {
    try {
      ...
      const res = await axios.post(
        "http://32.192.230.40:5050/api/profile-settings/request-update",
        payload,
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem("token")}`,
  ...
  const verifyOtp = async () => {
    ...
    try {
      await axios.post(
        "http://32.192.230.40:5050/api/profile-settings/verify-update",
        { otp: otpValue },
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem("token")}`,
  ...
  const disconnectGoogle = async () => {
    try {
      await axios.delete("http://32.192.230.40:5050/api/profile-settings");
